...
<body>
	<div class="container">
		<form method="POST">
			...
			<div class="nhomtext">Ten sach: <input type="text" name="tens"  placeholder="Nhập tên sách"></div>
			<div class="nhomtext">Nam xuat ban: <input type="date" name="nxb" placeholder="Nhập năm xuất năm xuất bản"></div>
			<div class="nhomtext">
				Ten tac gia:
				<select name="tg">
					<?php 
			...
			<div class="nhomnut">
				<input type="submit" name="nutthem" value="Insert">
